function updateCount() {
  ...
  var listLength = $('#packingList li').length;
...
$('#packingForm').on('submit', function(e) {
  ...
  var inputVal = $('#newItemDescription').val();
  
  $('#newItemDescription').val('');
  
  var newListItem = '<li><input type="checkbox"><span class="item">' + inputVal + '</span><a href="#" class="edit">Edit</a><a href="#" class="remove">Remove</a></li>';
